...
(defclass note-on-midi-message (midi-message)
  ())
(defclass note-off-midi-message (midi-message)
  ())
(defclass key-pressure-midi-message (midi-message)
  ())
(defclass control-change-midi-message (midi-message)
  ())
(defclass channel-mode-midi-message (control-change-message)
  ())
(defclass program-change-midi-message (midi-message)
  ())
(defclass channel-pressure-midi-message (midi-message)
  ())
(defclass pitch-bend-midi-message (midi-message)
  ())
...
(defclass clock-message (sysex-message)
  ())
(defclass start-message (sysex-message)
  ())
(defclass continue-message (sysex-message)
  ())
(defclass stop-message (sysex-message)
  ())
(defclass song-position-pointer (sysex-message)
  ())
